...
#import "LLCalenderViewController.h"
#import "LLCalendarView.h"
#import "NSDate+extend.h"

@interface LLCalenderViewController ()
@property (nonatomic, strong)LLCalendarView    *calendarView;//日历控件
@property (nonatomic, strong)NSMutableArray *seletedDays;//选择的日期

@property (nonatomic, copy)NSString *showStr;
@end

@implementation LLCalenderViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //日期选择
    if (!_calendarView) {
        _calendarView = [[LLCalendarView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH,SCREEN_HEIGHT)];
